...
<body>
  <section class="login-dark" style="height: 1000px;">
    <form method="post">
      ...
      <div class="form-group"><select class="form-control" name="id" id="id" style="color: #6f7a85;">
          <option value="" selected="" disabled="disabled">Escolha o Bolsista</option>
          <?php include("assets/database/selec_nome.php"); ?>
        </select></div>
      ...
      <div id="relatorio">
        <div class="form-group"><input class="form-control" type="text" id="parcela" placeholder="Parcela do Mês Atual"
            name="parcela"></div>
        <div class="form-group"><input class="form-control" type="text" id="periodoMensal" placeholder="Período Mensal"
            name="periodoMensal"></div>
        <div class="form-group"><input class="form-control" type="text" id="chMensal" placeholder="Carga Horária Mensal"
            name="chMensal"></div>
      </div>
      <div class="form-group"><input class="form-control" type="password" id="senha" name="senha" placeholder="Senha"></div><a
        class="forgot" href="recuperar.php">Esqueceu a senha?</a>
      <div class="form-group"><button class="btn btn-primary btn-block" type="button" id="botao" onclick="geraDoc()">
        <span class="spinner-border spinner-border-sm sr-only" id="carregar" role="status" aria-hidden="true"></span>
        Gerar Documento
      </button></div><a
        class="forgot" href="cadastro.php">Você não possui cadastro?</a>
    </form>
  </section>
